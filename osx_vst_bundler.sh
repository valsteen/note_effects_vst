...
for BUNDLE_LIB in "NoteGenerator note_generator" "NoteOffDelay note_off_delay" "AudioData filter_out_non_note" \
 "NoteFanOut note_fan_out" "MidiDelay midi_delay" "AudioData audio_data"; do
