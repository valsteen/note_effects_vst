...
for BUNDLE_LIB in "NoteGenerator note_generator" "NoteOffDelay note_off_delay" "FilterOutNonNote filter_out_non_note" "NoteFanOut note_fan_out" "MidiDelay midi_delay"; do
